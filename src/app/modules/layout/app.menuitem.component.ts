    ...
    template: `
		<ng-container>
			...
			<a *ngIf="(item.routerLink && !item.items) && item.visible !== false" (click)="itemClick($event)" [ngClass]="item.class" 
			   [routerLink]="item.routerLink" [routerLinkActive]="item.activeIgnor?'':'active-route'" [routerLinkActiveOptions]="item.routerLinkActiveOptions||{ paths: 'exact', queryParams: 'ignored', matrixParams: 'ignored', fragment: 'ignored' }"
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    updateActiveStateFromRoute() {
        ...
        if (activeRoute && !this.item.activeIgnor) {
