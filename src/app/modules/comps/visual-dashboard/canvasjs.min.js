...
B[B.length-1-a].exploded?!1:!0:B[a].exploded=B[a].exploded?!1:!0;l(x,b,2000)}};return{source:Q,dest:this.plotArea.ctx,animationCallback:function(a,b){J.fadeInAnimation(a,b);1<=a&&(l(x,-1,2000),v(x.plotArea.ctx||x.ctx))},easingFunction:J.easing.easeInQuad,animationBase:0}}}}};l.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,
