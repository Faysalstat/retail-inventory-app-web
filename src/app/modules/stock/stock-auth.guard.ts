...
export class StockAuthGuard implements CanActivateChild {
  constructor(
  ...
  async verifyStock(token: any) {
    ...
    if (authenticated.body.userRole == 'ADMIN' || authenticated.body.userRole == 'MANAGER') {
      ...
      this.notificationService.showErrorMessage("WARNING!!","You Are Not Permited To Access Stock Panel","OK",2000);
