...
@Component({
  selector: 'app-stock-sale-report',
  templateUrl: './stock-sale-report.component.html',
  styleUrls: ['./stock-sale-report.component.css']
})
export class StockSaleReportComponent implements OnInit {
  offset:number = 0;
  limit = 5;
  length = 100;
  pageSize = 10;
  ...
  fetchOrderRecord(){
    ...
    this.reportService.fetchStockSaleReport(this.queryBody).subscribe({
      next:(res)=>{
